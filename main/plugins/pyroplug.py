        ...
        try:
            ...
            if msg.media==MessageMediaType.VIDEO_NOTE:
              ...
              #  subprocess.call(['ffmpeg', '-hide_banner', '-loglevel', 'quiet', '-i', file, '-c:v', 'libx265', '-preset', 'ultrafast', '-crf', '25', '-tag:v', 'hvc1', '-c:a', 'copy', compressed_file])
                subprocess.call(['./ffmpeg/ffmpeg', '-hide_banner', '-loglevel', 'quiet', '-i', file, '-map', '0', '-c:v', 'libx265', '-color_primaries', '1', '-color_trc', '1', '-colorspace', '1', '-pix_fmt', 'yuv420p', '-color_range', '2', '-x265-params', 'level=6.1:high-tier=1:profile=main', '-preset', 'ultrafast', '-crf', '25', '-tag:v', 'hvc1', '-acodec', 'libopus', '-b:a', '192k', '-ar', '48000', compressed_file])
