    ...
    if 't.me/c/' in msg_link or 't.me/b/' in msg_link:
        ...
        try:
            ...
            if msg.media==MessageMediaType.VIDEO_NOTE:
                ...
                cmd_f = ['ffmpeg', '-y', '-hide_banner', '-loglevel', 'quiet','-threads', '16', '-i', file, '-map', '0', '-c:v', 'libx265', '-color_primaries', '1', '-color_trc', '1', '-colorspace', '1', '-pix_fmt', 'yuv420p', '-color_range', '2', '-x265-params', 'no-strict-cbr=1:log-level=warning:level=6.1:high-tier=1:profile=main', '-preset', 'ultrafast', '-crf', '23', '-tag:v', 'hvc1', '-acodec', 'copy', '-c:s', 'copy', compressed_file]
